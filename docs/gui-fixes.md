...
- **文件**：`gui/src/layout/AppFrame.module.css`、`gui/src/layout/AppFrame.tsx`、`gui/src/styles/app.css`
...
- **文件**：`gui/src/filetag/MentionInput.tsx`
...
- **文件**：`gui/src/chat/Conversation.tsx`
...
- **文件**：`gui/src/traffic/QueueBar.tsx`、`gui/src/traffic/slots.tsx`、`gui/src/traffic/traffic.module.css`
...
- **文件**：`gui/src/chat/Conversation.tsx`、`gui/src/chat/conversation.module.css`
...
- **症状**：`gui/src/context/fold.ts:58` 报 `'time' is never reassigned. Use 'const'`
- **修复**：`let time = 0` → `const time = 0`
- **文件**：`gui/src/context/fold.ts`
