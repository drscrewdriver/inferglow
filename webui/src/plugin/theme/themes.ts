...
export const THEMES: Record<string, Theme> = {
  ...
  'warm-paper': {
    ...
    text: '#2b2a26', textDim: '#6d6a5f', textFaint: '#9c987f', accent: '#8fa86a', accentSoft: 'rgba(143,168,106,.12)',
  ...
  'high-contrast': {
    ...
    text: '#1f1e1c', textDim: '#5a574f', textFaint: '#8a877e', accent: '#5a9f7a', accentSoft: 'rgba(90,159,122,.12)',
  ...
  'grass-aroma': {
    ...
    text: '#2a2f26', textDim: '#5f6b52', textFaint: '#8b977c', accent: '#85ac62', accentSoft: 'rgba(133,172,98,.12)',
  ...
  contemplation: {
    ...
    text: '#282d33', textDim: '#5f6b75', textFaint: '#8b97a0', accent: '#6a9fc8', accentSoft: 'rgba(106,159,200,.12)',
  ...
  absolutely: {
    ...
    text: '#2b2a26', textDim: '#6b675c', textFaint: '#989588', accent: '#b09050', accentSoft: 'rgba(176,144,80,.12)',
    coral: '#c97a5a', gold: '#a87a20',
  },
  delve: {
    ...
    text: '#262626', textDim: '#5f5f5a', textFaint: '#8c8c87', accent: '#7aaf60', accentSoft: 'rgba(122,175,96,.12)',
    coral: '#c97a5a', gold: '#b8923f',
  },
  'deep-think': {
    ...
    text: '#26262a', textDim: '#5f5f68', textFaint: '#8c8c95', accent: '#7a7ac0', accentSoft: 'rgba(122,122,192,.12)',
  ...
  'new-warm-paper': {
    ...
    text: '#2b2a26', textDim: '#6d685c', textFaint: '#99927f', accent: '#b09050', accentSoft: 'rgba(176,144,80,.12)',
    coral: '#c97a5a', gold: '#a87a20',
  },
  'midnight-contrast': {
  ...
  coral: {
    ...
    text: '#2b2a26', textDim: '#6d685c', textFaint: '#99927f', accent: '#d89878', accentSoft: 'rgba(216,152,120,.14)',
  ...
  jrti: {
    ...
    text: '#2b2822', textDim: '#6f6a5e', textFaint: '#9c967f', accent: '#c89a58', accentFg: '#ffffff', accentStrong: '#d8b070', accentSoft: 'rgba(200,154,88,.13)',
    coral: '#c97a5a', gold: '#b8923f', goal: '#6a9fc8', goalStrong: '#8abce0', aA: '#c89a58', aB: '#c9a87a', aA2: '#8abce0', aB2: '#6a9fc8',
  },
  gravitas: {
