module github.com/inferglow/security

go 1.25.0

require github.com/inferglow/orchestrator v0.0.0

require github.com/inferglow/session v0.0.0
...
// Transitive deps of orchestrator — Go does not inherit replace
// directives from dependencies, so they must be re-declared here.
