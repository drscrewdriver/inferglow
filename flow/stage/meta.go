...
//
// This file adds the port/metadata model (StageMeta) that declares a stage's
// explicit input/output port schema and metadata. The model coexists with the
// existing StageFunc registration: stages may carry a StageMeta alongside their
...
// StageMeta declares a stage's explicit input/output port schema and metadata.
//
...
func (m StageMeta) InputPort(name string) (PortDef, bool) {
...
func (m StageMeta) OutputPort(name string) (PortDef, bool) {
